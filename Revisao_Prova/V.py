...
#2 Quantas vezes o trecho de pseudocódigo seguinte imprime
#'oi'? (obs: na nossa pseudo-linguagem, o laço inclui os
#extremos, ou seja, 1 até 4 significa 1, 2, 3, 4.)
cont = 0
for i in range(1,10):
    if i != 3:
        for j in range(1,7):
...
#3 Entre 1067 e 3627 (inclusive), quantos números são pares e
...
#4 Daniela é uma pessoa muito supersticiosa. Para ela, um número é
#sortudo se ele contém o dígito 2 mas não o dígito 7. Então,
#na opinião dela, quantos números sortudos existem entre 18644 e 33087,
...
#5 Na pacata vila campestre de Ponteironuloville, todos os telefones
...
lista ='''213752 216732 221063 221545 225583 229133 230648 233222 236043 237330
        ...
        657143 659902 662224 666265 668010 672480 672695 676868 677125 678315'''.split()
def duplo(f):
    for b in range(0,10):
        if str(b) + str(b) in f:
            return True
